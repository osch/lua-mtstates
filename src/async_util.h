...
#ifndef MTSTATES_ASYNC_UTIL_H
#define MTSTATES_ASYNC_UTIL_H

/* -------------------------------------------------------------------------------------------- */

#define async_util_abort mtstates_async_util_abort
...
#define async_lock_init mtstates_async_lock_init
void async_lock_init(Lock* lock);

/* -------------------------------------------------------------------------------------------- */

#define async_lock_destruct mtstates_async_lock_destruct
...
#define async_mutex_init mtstates_async_mutex_init
void async_mutex_init(Mutex* mutex);

/* -------------------------------------------------------------------------------------------- */

#define async_mutex_destruct mtstates_async_mutex_destruct
...
#define async_mutex_wait mtstates_async_mutex_wait
void async_mutex_wait(Mutex* mutex);

/* -------------------------------------------------------------------------------------------- */

#define async_mutex_wait_millis mtstates_async_mutex_wait_millis
