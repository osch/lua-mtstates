...
void mtstates_async_lock_init(Lock* lock)
{
...
void mtstates_async_lock_destruct(Lock* lock)
{
#if defined(MTSTATES_ASYNC_USE_PTHREAD)
...
void mtstates_async_mutex_init(Mutex* mutex)
{
#if defined(MTSTATES_ASYNC_USE_PTHREAD)
...
void mtstates_async_mutex_destruct(Mutex* mutex)
{
#if defined(MTSTATES_ASYNC_USE_PTHREAD)
...
void mtstates_async_mutex_wait(Mutex* mutex) 
{
#if defined(MTSTATES_ASYNC_USE_PTHREAD)
...
bool mtstates_async_mutex_wait_millis(Mutex* mutex, int timeoutMillis)
{
#if defined(MTSTATES_ASYNC_USE_PTHREAD)
